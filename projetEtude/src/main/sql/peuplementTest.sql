...
-- Evenement
INSERT INTO `evenement`(`idEvenement`,`idCommission`,`titreEvent`,`descriptionEvent`,`lieuEvent`,`dateDebut`,`dateFin`) VALUES (1,1,'Salon gastronomique','Viens gouter les saveur d Espagne �a va �tre trop bon','RR034','2014-02-24 12:00','2014-02-24 13:00');
INSERT INTO `evenement`(`idEvenement`,`idCommission`,`titreEvent`,`descriptionEvent`,`lieuEvent`,`dateDebut`,`dateFin`) VALUES (2,2,'Soir�e Rock','Viens danser un rock endiabl� des 80s','Salle de sport','2014-02-26 19:45','2014-02-26 22:00');

-- Commission
INSERT INTO `commission`(`idCommission`,`idEtudiant`,`idPole`,`nomCommission`,`descriptionCom`,`adresseLogo`) VALUES (1,2,1,'La Sauce','Le plaisir de manger entre �tudiants','img/bda.jpg');
