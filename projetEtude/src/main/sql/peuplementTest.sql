...
INSERT INTO `etudiant`(`idEtudiant`,`nomEtudiant`,`prenomEtudiant`,`password`,`email`,`idDroit`,`firstConnexion`) VALUES (17,'Potter','Harry','etudiant','harry.potter@hei.fr',0,0);
...
INSERT INTO `etudiant`(`idEtudiant`,`nomEtudiant`,`prenomEtudiant`,`password`,`email`,`idDroit`,`firstConnexion`) VALUES (10,'Dick','Boby','pres','boby.dick@hei.fr',1,0);
INSERT INTO `etudiant`(`idEtudiant`,`nomEtudiant`,`prenomEtudiant`,`password`,`email`,`idDroit`,`firstConnexion`) VALUES (11,'Talon','Achille','pres','achille.talon@hei.fr',1,0);

-- responsable pole
INSERT INTO `etudiant`(`idEtudiant`,`nomEtudiant`,`prenomEtudiant`,`password`,`email`,`idDroit`,`firstConnexion`) VALUES (12,'Elle','Lui','pres','lui.elle@hei.fr',2,0);
INSERT INTO `etudiant`(`idEtudiant`,`nomEtudiant`,`prenomEtudiant`,`password`,`email`,`idDroit`,`firstConnexion`) VALUES (13,'Gordon','Jim','pres','jim.gordon@hei.fr',2,0);
INSERT INTO `etudiant`(`idEtudiant`,`nomEtudiant`,`prenomEtudiant`,`password`,`email`,`idDroit`,`firstConnexion`) VALUES (14,'Cola','Coca','pres','coca.cola@hei.fr',2,0);
INSERT INTO `etudiant`(`idEtudiant`,`nomEtudiant`,`prenomEtudiant`,`password`,`email`,`idDroit`,`firstConnexion`) VALUES (15,'Twix','Sweet','pres','sweet.twix@hei.fr',2,0);
INSERT INTO `etudiant`(`idEtudiant`,`nomEtudiant`,`prenomEtudiant`,`password`,`email`,`idDroit`,`firstConnexion`) VALUES (16,'TheBullet','Bang','pres','bang.thebullet@hei.fr',2,0);
...
INSERT INTO `calendrier`(`idCalendrier`,`idEtudiant`,`dateEmission`) VALUES (17,17,'2014-07-19');

INSERT INTO `calendrier`(`idCalendrier`,`idEtudiant`,`dateEmission`) VALUES (15,15,'2014-07-19');
INSERT INTO `calendrier`(`idCalendrier`,`idEtudiant`,`dateEmission`) VALUES (16,16,'2014-07-19');

-- Pole
INSERT INTO `pole`(`idPole`,`nomPole`,`idEtudiant`) VALUES (1,'BDA',12);
INSERT INTO `pole`(`idPole`,`nomPole`,`idEtudiant`) VALUES (2,'BDS',13);
INSERT INTO `pole`(`idPole`,`nomPole`,`idEtudiant`) VALUES (3,'CapSo',14);
INSERT INTO `pole`(`idPole`,`nomPole`,`idEtudiant`) VALUES (4,'PES',15);
INSERT INTO `pole`(`idPole`,`nomPole`,`idEtudiant`) VALUES (5,'PET',16);
...
INSERT INTO `commission`(`idCommission`,`idEtudiant`,`idPole`,`nomCommission`,`descriptionCom`,`adresseLogo`) VALUES (6,10,4,'Heisy Jet','Profitez des voyages proposés par cette associaction et de ses tarifs défiant toutes concurrences','img/logo/heisy_jet.jpg');
INSERT INTO `commission`(`idCommission`,`idEtudiant`,`idPole`,`nomCommission`,`descriptionCom`,`adresseLogo`) VALUES (7,11,3,'Baobab','Association humanitaire, voyage dans un pays défavorisé à la fin de l''année','img/logo/baobab.jpg');
...
INSERT INTO `evenement`(`idEvenement`,`idCommission`,`nomCommission`,`nomPole`,`titreEvent`,`descriptionEvent`,`lieuEvent`,`dateDebut`,`dateFin`,`heureDebut`,`heureFin`,`image`,`moderation`) VALUES (6,5,'Cosmo','PES','Voyage autour de la Terre','Nous allons te faire tourner autour du monde','RR120','2016-12-03','2016-12-03',' 12:00:00','13:00:00','img/logo/cosmo.jpg',false);
INSERT INTO `evenement`(`idEvenement`,`idCommission`,`nomCommission`,`nomPole`,`titreEvent`,`descriptionEvent`,`lieuEvent`,`dateDebut`,`dateFin`,`heureDebut`,`heureFin`,`image`,`moderation`) VALUES (7,4,'HEIvolution','PET','Challenge avec Roquette','Participe au nouveau challenge de HEI, trouvons le nouveau produit de demain en une journée','J001','2016-09-15','2016-09-15',' 08:30:00','17:30:00','img/logo/heivolution.jpg',false);
