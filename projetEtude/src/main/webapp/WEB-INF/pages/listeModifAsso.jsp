				...
				<div id="tab1" class="tab_content"> 
					<ul class="taille15">
						<c:forEach var="commission" items="${listeComm}">
							...
							<li class="styleList"><div class="nomComListMod">${commission.nomCommission}</div> <a href="modifierAsso?idcommission=${commission.idcommission}" class="btnModif">Modifier</a>    <div id="${commission.idcommission}" class="btnSuppr">Supprimer</div></li>
							</c:if>
						</c:forEach>
					</ul>
				</div><!-- #tab1 -->
